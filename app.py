...
st.markdown(
    ...
    div.stButton, div.stFormSubmitButton { width: 100%; }
    div.stButton > button, div.stFormSubmitButton > button { width: 100%; min-height: 64px; border: 0; border-radius: 14px; background: #d84949; color: white; font-size: 1.2rem; font-weight: 800; box-shadow: 0 4px 0 #a72e2e; }
    div.stButton > button:hover, div.stFormSubmitButton > button:hover { background: #c83d3d; color: white; border: 0; }
